...
class Camera {
    ...
    projectPoint(point2D) {
        ...
        let point_H = vec3.fromValues(point2D[0], point2D[1], 0)
        let point_C = vec3.transformMat3(vec3.create(), point_H, this.cameraMatrix)
        let point_P = vec3.transformMat3(vec3.create(), point_C, this.projectionMatrix)
        let de_point_P = vec2.fromValues(point_P[0]/point_P[2], point_P[1]/point_P[2])
